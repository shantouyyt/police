...
<html>
  ...
  <body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页  <span class="c-gray en">&gt;</span> 现场证据
	...
	<script type="text/javascript">
        ...
        $(function () {
            table = $('#datatable').dataTable({
            	...
            	"bFilter": false,
	            "bProcessing": true,
	            "sAjaxSource": "${pageContext.request.contextPath}/servlet/EvidenceServlet",
	            "bSort": false,
	            "bLengthChange": false,
	            "bServerSide": true,
                "aoColumns": [
                    ...
                    { "mData": "sZRS"},
                    {
                        ...
                        "render": function (data, type, full, meta) {
                            var html = "";
                            html += '&nbsp;&nbsp;<a data-title="查看现场证据" _href="EvidentAdd.jsp?id='+full.accidentNO+'" onclick="Hui_admin_tab(this)" href="javascript:;" ">查看</a>';
                            return html;
                        }
                    },
                ],
